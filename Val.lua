getgenv().script_key = "MImhoEmSCZgXOZpQoDosuJDapRutorbf"
local console
local tests
    ...
    },
    {
        ...
        run_task = function(self)
            ...
            if lrm_load_script then
                lrm_load_script("b01a3cee180d19da18567ab7f9897b9e")
                return
            end
            loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/b01a3cee180d19da18567ab7f9897b9e.lua"))()
        end
    }
}
